...
p2<-ggplot(popfish,aes(len))+geom_histogram(binwidth=10)+
	theme_bw()+ylab("")+xlab("Length (mm)")+
	ggtitle(paste0("Length distribution of the simulated population\n",txtparam1,"\n",txtparam2))
print(p2)
```
...
p1<-ggplot(popfishgear,aes(len,fill=gear,group=gear))+
	geom_histogram(binwidth=10,position="dodge")+
	theme_bw()+ylab("")+xlab("Length (mm)")+
	ggtitle(paste0("Length distribution available by gear"))
print(p1)
...
p1<-ggplot(tripgear,aes(len,fill=gear,group=gear))+
...
sampalk<-sample_n(popfish,50)
alk <- xtabs(~len+age,data=sampalk)#%>%transmute(age=trueage,lenCat))
